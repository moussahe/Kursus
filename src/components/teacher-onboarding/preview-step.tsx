  ...
  return (
    <div className="space-y-6 p-6 sm:p-8">
      ...
      <div className="text-center">
        ...
        >
          <Eye className="h-6 w-6 text-[#ff9494]" />
        </motion.div>
      ...
      >
        <Card className="overflow-hidden rounded-2xl border-0 shadow-lg">
          ...
          <div className="bg-gradient-to-br from-[#ff9494] to-[#ff7070] p-6 text-white">
          ...
          <CardContent className="p-6">
            ...
            <div className="flex items-center gap-4 rounded-xl bg-gray-50 p-4">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#ff9494]/10 text-xl font-bold text-[#ff9494]">
            ...
            {/* Revenue Breakdown */}
            <div className="mt-4 rounded-xl border border-[#ff9494]/20 bg-[#ff9494]/10 p-4">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-[#ff9494]">
                    Votre part (70%)
                  </span>
            ...
            <div className="mt-4">
              ...
              <div className="space-y-2">
                {data.course.chapters.map((chapter, index) => (
                  ...
                  >
                    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#ff9494]/10 text-xs font-medium text-[#ff9494]">
                      {index + 1}
                    </div>
                    <div className="flex-1">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          >
            J&apos;accepte les{" "}
            <a href="/terms" className="text-[#ff9494] underline">
              conditions d&apos;utilisation
            </a>{" "}
            et la{" "}
            <a href="/privacy" className="text-[#ff9494] underline">
      ...
      <div className="flex gap-3">
        ...
        <Button
          onClick={onPublish}
          disabled={!canPublish}
          className="flex-1 rounded-xl bg-gradient-to-r from-[#ff9494] to-[#ff7070] py-6 text-lg font-semibold hover:from-[#6966ff] hover:to-[#5558e8]"
        >
          {isLoading ? (
            <>
  ...
  return (
    <div className="space-y-6 p-6 sm:p-8 text-center">
      <motion.div
        ...
        className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-[#ff9494] to-[#ff7070]"
      >
      ...
      <motion.div
        ...
        className="rounded-2xl bg-gradient-to-br from-[#ff9494]/5 to-[#ff7070]/5 p-6"
      >
      ...
      >
        ...
        <a href="/help/teachers" className="text-[#ff9494] underline">
          guide du professeur
        </a>
      </motion.p>
    </div>
